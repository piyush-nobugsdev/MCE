    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-sky-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-1">Sign in to your <span className="text-blue-600 font-semibold">Worker</span> account</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-blue-100 border border-blue-50 p-8">
          ...
          <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    disabled={otpSent}
                    className="w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent disabled:bg-gray-50 disabled:text-gray-400 transition"
                  />
                </div>
                <button
                  onClick={handleSendOtp}
                  disabled={sendingOtp || otpSent}
                  className="px-4 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-300 text-white text-sm font-semibold rounded-xl transition whitespace-nowrap flex items-center gap-1"
                >
              ...
              <div className="animate-in slide-in-from-top-2 duration-300">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 border border-gray-200 rounded-xl text-sm tracking-widest font-mono focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition"
                  />
                  <button
            ...
            <button
              ...
              className="w-full py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-200 disabled:cursor-not-allowed text-white font-semibold rounded-xl transition flex items-center justify-center gap-2"
            >
              {verifying ? (
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            New here?{' '}
            <Link href="/auth/worker/signup" className="text-blue-600 hover:text-blue-700 font-semibold">
              Create an account
            </Link>
          </p>
        </div>
