...
import { Phone, Loader2, HardHat } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-gray-900 leading-tight">{t('worker_login')}</h1>
          <p className="text-gray-500 mt-2 font-medium">{t('find_work')}</p>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-6 py-4 border border-gray-100 rounded-xl text-xl font-bold focus:outline-none focus:ring-4 focus:ring-blue-50 focus:border-blue-400 transition-all disabled:opacity-50"
                  />
                </div>
              </div>
              ...
              {otpSent && (
                <div className="space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 border border-gray-100 rounded-xl text-2xl font-bold text-center tracking-[0.3em] focus:outline-none focus:ring-4 focus:ring-blue-50 focus:border-blue-400 transition-all"
                  />
                </div>
              )}
              ...
              {!otpSent ? (
                <Button 
                  ...
                  disabled={sendingOtp}
                  className="w-full h-16 bg-blue-600 hover:bg-blue-700 rounded-xl text-lg font-bold text-white shadow-md shadow-blue-50"
                >
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 font-medium">
            {t('create_account')}?{' '}
            <Link href="/auth/worker/signup" className="text-blue-600 font-bold hover:underline">
              {t('register')}
            </Link>
          </p>
        </div>
