                       ...
                       <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                          ...
                          <div className="flex gap-3">
                             {app.status === 'pending' ? (
                               ...
                               <div className={`px-6 py-3 rounded-xl text-xs font-bold uppercase tracking-widest border ${
                                 app.status === 'accepted' ? 'bg-green-50 text-green-700 border-green-100' : 'bg-red-50 text-red-700 border-red-100'
                               }`}>
                                 {app.status}
                               </div>
                             )}
