...
import { Menu, X, Home, Briefcase, CheckCircle, DollarSign, LogOut, User, ChevronDown } from 'lucide-react'
...
export function WorkerNavbar() {
  ...
  const navItems = [
    ...
    { href: '/worker/applications', label: 'My Applications', icon: CheckCircle },
  ]
    ...
    <>
      ...
      <nav className="hidden md:flex bg-white border-b border-gray-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between w-full">
          <Link href="/worker/dashboard" className="text-xl font-bold text-blue-600">
            FarmWork
          </Link>
          ...
          <div className="flex items-center gap-4">
            <div className="relative group">
              <button className="flex items-center gap-2 px-3 py-2 rounded-xl bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors font-semibold">
              ...
              <div className="absolute right-0 mt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right translate-y-2 group-hover:translate-y-0 z-50">
                <div className="bg-white border border-gray-100 rounded-2xl shadow-xl p-2 pb-3">
                  ...
                  <Link href="/worker/profile" className="flex items-center gap-3 px-3 py-2.5 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-xl transition-colors">
                    <User className="w-4 h-4" /> My Profile
                  </Link>
                  <Link href="/worker/earnings" className="flex items-center gap-3 px-3 py-2.5 text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-xl transition-colors">
                    <DollarSign className="w-4 h-4" /> Earnings History
                  </Link>
              ...
              <div className="px-4 py-3 border-b border-gray-100 bg-gray-50/50">
                ...
                <div className="space-y-3">
                  ...
                  <Link 
                    ...
                    className="flex items-center gap-3 text-gray-700 hover:text-blue-600"
                  >
                    <DollarSign className="w-5 h-5" /> Earnings History
                  </Link>
                </div>
              </div>
              <button
